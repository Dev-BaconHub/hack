...
local WarnMessage = "VN:Main hiện đã bị xoá vì quá lỗi và sẽ chuyển sang kaitun | EN:Main has now been removed due to being too buggy and will be replaced with Kaitun."
